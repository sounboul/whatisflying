  ...
  <div class="dropend">
    ...
    <div class="dropdown-menu map-control-menu ms-2">
      ...
      <div class="mt-3">
        ...
        <AircraftTypeSelect id="inputAircraftType" mode="multiple" v-model="filters.aircraftType"/>
      </div>
      <div class="mt-3">
        <label class="form-label" for="inputCallsign">{{ $t('label.callsign') }}</label>
        <input class="form-control" id="inputCallsign" type="text" v-model="filters.callsign">
      </div>
      <div class="mt-3">
        <label class="form-label" for="inputSquawk">{{ $t('label.squawk') }}</label>
        <input class="form-control" id="inputSquawk" type="text" v-model="filters.squawk">
      </div>
      <div class="mt-3">
        <label class="form-label" for="inputMaximumAltitude">{{ $t('label.maximum_altitude') }}</label>
        <input class="form-control" id="inputMaximumAltitude" type="number" v-model="filters.maximumAltitude">
      </div>
      <div class="mt-3">
        <label class="form-label" for="inputMinimumAltitude">{{ $t('label.minimum_altitude') }}</label>
        <input class="form-control" id="inputMinimumAltitude" type="number" v-model="filters.minimumAltitude">
      </div>
