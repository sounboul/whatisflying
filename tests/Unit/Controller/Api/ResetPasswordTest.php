...
/**
 * @covers \App\Controller\Api\User\ResetPassword
 */
final class ResetPasswordTest extends TestCase
{
    ...
    public function testInvokeReturnUser(): void
    {
        ...
        $resetPassword = new ResetPassword($this->tokenManager);

        self::assertEquals($user, $resetPassword->__invoke($user));
    }
    ...
    public function testInvokeReturnUnauthorizedResponseOnUnknownToken(): void
    {
        ...
        self::assertInstanceOf(Response::class, $resetPassword->__invoke($user));
        self::assertEquals(401, $resetPassword->__invoke($user)->getStatusCode());
    }
